...
describe ContaPoupanca do
  describe 'Saque' do
    context 'quando o valor é positivo' do
      before(:all) do
        @cp = ContaPoupanca.new(1000.00) # @: deixa a variável global
        @cp.saca(200.00)
      end
      it 'entao atualiza sado' do
    ...
    context 'quando supera o limte de saque' do
      before(:all) do
...
# rspec --format html --out report.html (gera o html)
# rspec --format RspecJunitFormatter --out reposrt.xml -fd